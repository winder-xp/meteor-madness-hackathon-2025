...
There are [color=#eb8a29]several ways[/color] nuclear interceptors could be used for asteroid deflection. 
...
•	Nuclear devices also represent the [color=#eb8a29][u]most mass-efficient[/u][/color] way to store and deliver the vast amounts of energy needed for such 
...
•	If [color=#eb8a29][u]warning time is very short[/u][/color], less than three years before a possible impact, nuclear interceptors may be the only viable option, 
...
•	However, a [color=#eb8a29][u]very precise knowledge[/u][/color] of the asetroid’s composition, structure and shape would be essential to select the safest 
...
•	Furthermore, nuclear explosions represent a very [color=#eb8a29][u]drastic approach[/u][/color] to planetary defense, as it is nearly impossible to avoid 
