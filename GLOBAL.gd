...
var datos_asteroides: Dictionary = {'Itokawa': ['Itokawa',3.15e10,0.33,1.9e3,'silicates and rock-forming minerals such as olivine and pyroxene','porus and therefore easily fragmenting material',7,2,3,'the kinetic impactor'], 
